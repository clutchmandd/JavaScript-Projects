...
const Calculator = {
    ...
    Display_Value: '0',
    // this will hold the first operand for any expressions, we will start with it null
    First_Operand: null,
  ...
  function Input_Digit(digit) {
      ...
      if (Wait_Second_Operand === true) {
          ...
          // this overwrites Display_Value if the current value
  ...
  function Handle_Operator(Next_Operator) {
      ...
      // when an operator key is pressed, we convert the curren number
      ...
      if (First_Operand == null) {
          Calculator.First_Operand = Value_of_Input;
            ...
            //operator in the Perfom_Calculation object and the
